create or replace function reportar_rendimiento_llamado_finalizado(filaNueva record) returns void as $$
...
begin 
	...
	if found then
		...
		-- update datos atenciones finalizadas:

		duracion_atenciones_finalizadas_incluyendo_actual =
			rendimiento_operadore_actual.duracion_atenciones_finalizadas + duracion_atencion_actual;

		cantidad_atenciones_finalizadas_incluyendo_actual = 
			rendimiento_operadore_actual.cantidad_atenciones_finalizadas + 1;

		duracion_promedio_atenciones_finalizadas_incluyendo_actual =
			duracion_atenciones_finalizadas_incluyendo_actual / cantidad_atenciones_finalizadas_incluyendo_actual;
		...
		duracion_atenciones_finalizadas = duracion_atenciones_finalizadas_incluyendo_actual,
		cantidad_atenciones_finalizadas = cantidad_atenciones_finalizadas_incluyendo_actual,
		duracion_promedio_atenciones_finalizadas = duracion_promedio_atenciones_finalizadas_incluyendo_actual
		where filaNueva.id_operadore = r.id_operadore and fecha_atencion_actual = r.fecha_atencion;
			...
			values(
				...
				duracion_atencion_actual,		-- duracion_atencioniones_finalizadas
				1,								-- cantidad_atenciones_finalizadas
				duracion_atencion_actual,		-- duracion_promedio_atenciones_finalizadas
				'00:00:00', 					-- duracion_atenciones_desistidas
				0, 								-- cantidad_atenciones_desistidas
